...
<body style="   background-image: url('../admin/images/burger\ \(6\).jpg');
    ...
    <form action="chef.php" method="POST">
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add'])) {
            ...
            $desc1 = $_POST['desc1'];
            $desc2 = $_POST['desc2'];
            $add = "insert into `chefs_deatils`(`id`,`image`,`name`,`desc1`,`desc2`) values(NULL,'$image','$name','$desc1','$desc2')";
    ...
    <form action="chef.php" method="POST">
        <center>
            <div class="t-heading glass" style="width: 90%;">
                <div class="con1">
                    <h2>Chefs information</h2>
                </div>
                <div class="rin">
                    <a href="../admin/add_chef.php" style="text-decoration:none;font-size:large;">Add new
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td style="width:30%;"><?php echo $row['desc1']; ?></td>
                                <td style="width: 30%;"><?php echo $row['desc2']; ?></td>
                                <td>
                                    <Center>
                                        <a href='../admin/update_chef.php?updateid=<?php echo $id; ?>'
                                            style="color:blue;">Update
                                            <i class="fa-solid fa-pen"></i></a><br><br>
                                        <a href='delete_chef.php?deleteid=<?php echo $id; ?>' style="color:red;">Delete <i
