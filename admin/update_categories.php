      ...
      background-size: contain;">
            ...
            if (isset($_GET['update2'])) {
                ...
                if ((preg_match('/^[a-zA-Z ]*$/', $name))) {
                    $update = "UPDATE `categories` SET `name` = '$name', `image` = '$image',`details`='$details' WHERE `categories`.`id` = $id;";
            ...
            ?>
                    ...
                    if ($num > 0) {
                        while ($ram = mysqli_fetch_assoc($result)) {
                    ?>
                            <form action="update_categories.php" method="get">
                                ...
                                <main class="contact-container glass">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="subject" name="details" value="<?php echo $ram['details']; ?>" required>
                                    </div>
                            <?php }
                    } ?>
                            <center>
                            ...
                            <form action="update_categories.php" method="get">
                                ...
                                <main class="contact-container glass">
                                    ...
                                    ?>
                                            ...
                                            <div class="form-group">
                                                <label for="subject">Details :-</label>
                                                <input type="text" id="subject" name="details" value="<?php echo $ram['details']; ?>"
                                                    required>
                                            </div>
                                    <?php }
                                    } ?>
