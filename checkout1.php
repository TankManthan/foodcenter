...
<head>
    ...
    <style>
    body {
        background-image: url("../foodcenter/images/img3.jpg");
...
<body style="background-image: url('admin/images/background.jpg');background-size:contain">
    ...
    <center>
        <div class="rin">
            ...
            <div class="img">
                <img src="../foodcenter/admin/images/<?php echo $row['image']; ?>" alt="loading"
            ...
            <div class="details">
                ...
                <div class="quantity">
                    <p style="display: inline;">Enter Qunatity :-</p>
                    <input type="number" name="quantity" value="1" min="1" required
                        style="height: 20px;border-radius:10px;border:none;margin-left:10px;">
                </div>
            </div>
            <a href="checkout2.php">
                <input type="submit" name="checkout" value="Place Order" class="btn" onclick="checkout2.php">
            </a>
        </div>
    </center>
    <?php
    ...
    } elseif (isset($_GET['famous_id'])) {
        $famous_id = $_GET['famous_id'];
        include 'connect.php';
        $sql = "select * from `products` where `id`=$famous_id";
        $result = mysqli_query($con, $sql);
        $no = mysqli_num_rows($result);
        if ($no > 0) {
            while ($row = mysqli_fetch_assoc($result)) {
    ...
    <center>
        <div class="rin">
            ...
            <div class="details">
                ...
                <div class="quantity">
                    <p style="display: inline;color:white;">Enter Qunatity :-</p>
                    <input type="number" name="quantity" value="1" min="1" required
                        style="height: 20px;border-radius:10px;border:none;margin-left:10px;">
                </div>
